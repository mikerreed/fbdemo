...
var ASM_CONSTS = {
  ...
  function _ptrk_canvas_onClipPath(ctxID, ptsptr, npts, vbsptr, nvbs, fillType) {
  ...
  function _ptrk_canvas_onConcat(ctxID, a, b, c, d, e, f) {
          const ctx = ptrk_get_object_from_id(ctxID);
          ctx.transform(a, b, c, d, e, f);
      }

  function _ptrk_canvas_onDrawPath(ctxID, ptsptr, npts, vbsptr, nvbs, fillType, isStroke) {
          const ctx = ptrk_get_object_from_id(ctxID);
          const path = ptrk_path_make(ptsptr, npts, vbsptr, nvbs);
          const rule = ptrk_path_fill_rule(fillType);
  ...
  function _ptrk_canvas_onDrawRect(ctxID, l, t, r, b, isStroke) {
          const ctx = ptrk_get_object_from_id(ctxID);
          if (isStroke != 0) {
  ...
  function _ptrk_canvas_onRestore(ctxID) {
          const ctx = ptrk_get_object_from_id(ctxID);
          ctx.restore();
      }

  function _ptrk_canvas_onSave(ctxID) {
          const ctx = ptrk_get_object_from_id(ctxID);
          ctx.save();
      }

  function _ptrk_canvas_setColor(ctxID, c32, isStroke) {
          const ctx = ptrk_get_object_from_id(ctxID);
  ...
  function _ptrk_canvas_setLinearGradient(ctxID, ptsptr, colorsptr, posptr, ncolors, isStroke) {
          const ctx = ptrk_get_object_from_id(ctxID);
  ...
  function _ptrk_canvas_setRadialGradient(ctxID, cx, cy, radius, colorsptr, posptr, ncolors, isStroke) {
          const ctx = ptrk_get_object_from_id(ctxID);
          const clr = new Uint32Array( Module.HEAPU32.buffer, colorsptr, ncolors);
          const pos = new Float32Array(Module.HEAPF32.buffer, posptr, ncolors);
  ...
  function _ptrk_canvas_setStrokeWidth(ctxID, width) {
          const ctx = ptrk_get_object_from_id(ctxID);
          ctx.lineWidth = width;
      }
...
var asmLibraryArg = {
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "ptrk_canvas_onClipPath": _ptrk_canvas_onClipPath,
  "ptrk_canvas_onConcat": _ptrk_canvas_onConcat,
  "ptrk_canvas_onDrawPath": _ptrk_canvas_onDrawPath,
  "ptrk_canvas_onDrawRect": _ptrk_canvas_onDrawRect,
  "ptrk_canvas_onRestore": _ptrk_canvas_onRestore,
  ...
  "ptrk_canvas_setRadialGradient": _ptrk_canvas_setRadialGradient,
